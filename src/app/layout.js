  ...
  return (
    <html lang="en">
      <body>
        ...
        <aside
          id="logo-sidebar"
          className="=-transform fixed left-0 top-0 z-40 h-screen w-48 -translate-x-full transition sm:translate-x-0 "
          aria-label="Sidebar"
        >
          <div className="h-full overflow-y-auto px-3 py-4 text-sky-700 dark:bg-gray-800">
            <a href="#" className="mb-5 flex items-center justify-center">
            ...
            <ul className="space-y-2 font-medium">
              ...
              <li>
                ...
                >
                  ...
                  <span className="ms-3 flex-1 whitespace-nowrap">재고관리</span>
                </a>
              </li>
              <li>
                <a
                ...
                >
                  ...
                  <span className="ms-3 flex-1 whitespace-nowrap">입고</span>
                </a>
              </li>
              ...
              <li>
                ...
                >
                  ...
                  <span className="ms-3 flex-1 whitespace-nowrap">발주</span>
                </a>
              </li>
              <li>
                <a
                ...
                >
                  ...
                  <span className="ms-3 flex-1 whitespace-nowrap">폐기</span>
                </a>
              </li>
            </ul>
          </div>
