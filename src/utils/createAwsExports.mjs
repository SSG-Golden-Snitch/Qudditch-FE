...
console.log(logPrefix, `No file found at ${configFilePath}. Getting env with aws-export...`)

const base64AwsExportsEnv = process.env.BASE64_AWS_EXPORTS

if (!base64AwsExportsEnv) {
  console.log(logPrefix, `No env variable called AWS_EXPORTS has been found. Stopping script!`)
  process.exit(1)
}
